...
public class SnakeTestReview extends JFrame implements Runnable {
...
//Speed of the snake.    
    ...
    static SnakeTestReview frame;
    public static void main(String[] args) {
        frame = new SnakeTestReview();
        frame.setSize(WINDOW_WIDTH, WINDOW_HEIGHT);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setVisible(true);
    }

    public SnakeTestReview() {
