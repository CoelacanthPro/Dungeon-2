...
public class Window {
    ...
    static final int WINDOW_WIDTH = 2*(WINDOW_BORDER + XBORDER) + Board.numColumns*50;
    static final int WINDOW_HEIGHT = YTITLE + WINDOW_BORDER + 2*YBORDER + Board.numRows*50;
    static int xsize = -1;
    static int ysize = -1;
/////////////////////////////////////////////////////////////////////////
